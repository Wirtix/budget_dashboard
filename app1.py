...
st.markdown('<h1 style="background-color:#092635; color:#F5E8C7;"> Current month stats: </h1>', unsafe_allow_html=True)
st.markdown('---')
...
st.markdown('<h1 style="background-color:#092635; color:#F5E8C7;"> Other stats: </h1>', unsafe_allow_html=True)
